...
WiiGUIData.LRFlip=0;
addpath([WiiGUIData.rootpath, 'wiicompare']);
...
flist=dir([WiiGUIData.datapath, '\*', refname, '*.csv']);
...
dataplay=cutdata(dataplay, WiiGUIData.dataref.playstart+0, WiiGUIData.dataref.playlength);
...
% hObject    handle to radiobuttonFlipLR (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of radiobuttonFlipLR
global WiiGUIData
