...
namespace Primitives3D
{
    ...
    public class Primitives3DGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (mySensorData.currentIndex >= (mySensorData.numData - 1))
                mySensorData.currentIndex = 0;
            else
                mySensorData.currentIndex++;

            int idx = mySensorData.currentIndex;

            Quaternion qtn = new Quaternion(mySensorData.quarternian[idx, 0], mySensorData.quarternian[idx, 1], mySensorData.quarternian[idx, 2], mySensorData.quarternian[idx, 3]);
            Matrix world = Matrix.CreateFromQuaternion(qtn);
